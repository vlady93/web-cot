            ...
            <div class="col-12">
                <div class="card card-secondary">
                    <div class="card-body">
                        ...
                        <form action="{{ route('liquidacion_detalles.update', $liquidacion_detalle) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                        ...
                                        <select class="form-control" name="liquidacion_detalles_id" required>
                                            @foreach ($terminos as $termino)
                                                <option value="{{ $termino->id }}"
                                                    @if ($termino->id == $liquidacion_detalle->liquidaciones_detalle_id) selected @endif>
                                                    {{ $liquidacion_detalle->termino->nombre }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                        ...
                                        <select class="form-control" name="cliente_id" id="cliente_id" required>
                                            ...
                                            @foreach ($clientes as $cliente)
                                                <option value="{{ $cliente->id }}"
                                                    @if ($cliente->id == $liquidacion_detalle->cliente_id) selected @endif>
                                ...
                                <div class="col-xs-2 col-sm-2 col-md-2">
                                    <div class="form-group">
                                        <strong>Libre:</strong>
                                        <input type="number" name="libre" id="libre" step="0.01"
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="col-xs-2 col-sm-2 col-md-2">
                                ...
                                <div class="col-xs-2 col-sm-2 col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="fraccion" id="fraccion" step="0.01"
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="col-xs-2 col-sm-23 col-md-2">
                                    <div class="form-group">
                                        <strong> </strong>
                                        <br>
                                        <button type="button" id="agregar" class="btn btn-success">Agregar
                                            Elemento</button>
                                    </div>
                                </div>
                                                    ...
                                                    @foreach ($penalidads as $penalidad)
                                                        <tr class="ItemElemento">
                                                            <td><button type="button"
                                                                    data-elemento="{{ $penalidad->elemento_id }}"
                                                                    class="delete btn btn-danger btn-sm"><i
                                                                        class="fa fa-times fa-2x"></i></button></td>
                                                            <td class="valor"><input type="hidden" id="elemento"
                                                                    name="elemento_id[]" class="elemen"
                                                                    value="{{ $penalidad->elemento_id }}">{{ $penalidad->elemento->simbolo }}
                                                            </td>
                                                            <td> <input type="number" name="libre[]" class="form-control"
                                                                    value="{{ $penalidad->libre }}"></td>
                                                            <td> <input type="number" name="costo[]" class="form-control"
                                                                    value="{{ $penalidad->costo }}"> </td>
                                                            <td> <input type="number" name="fraccion[]"
                                                                    class="form-control"
                                                                    value="{{ $penalidad->fraccion }}"> </td>
                                                        </tr>
                                                    @endforeach
                                                </tbody>
                                            </table>
